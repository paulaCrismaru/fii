...
def songs(artist):
	...
	response = unirest.get("https://deezerdevs-deezer.p.mashape.com/search?q="+artist,
	  headers={
...
def get_emotions(d, line):
	...
	response = unirest.get("http://gateway-a.watsonplatform.net/calls/text/TextGetEmotion?apikey=2b1df6cec16bba04eac124c83db20bc6622072f6&text="+ line +"&outputMode=json")
...
def get_lyrics(artist):
	...
	for song in song_list:
		d = {}
		song = song.replace(" ", "+")
		response = unirest.get("https://musixmatchcom-musixmatch.p.mashape.com/wsr/1.1/matcher.lyrics.get?q_artist=" + artist + "&q_track=" + song,
		  headers={
		    "X-Mashape-Key": "DgoyXd9bunmshI9yT2CZbaGMDhTPp1x6YvIjsnmUnx2XbEtDw4",
